/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 24ac6807a4bd9032270b04182ea1a418)
...
interface __BaseEnv_Env {
	...
	SSH_SESSIONS: DurableObjectNamespace<import("./src/index").SSHSessionDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LiveDataDO" | "RateLimitDO" | "SSHSessionDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "CONNECT_TIMEOUT_MS">> {}
}
