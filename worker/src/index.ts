...
app.get('/agent/install.sh', (c) => c.redirect('https://raw.githubusercontent.com/hynize/CF-Workers-VPSmonitor/main/agent/install.sh', 302));
app.get('/agent/install-linux.sh', (c) => c.redirect('https://raw.githubusercontent.com/hynize/CF-Workers-VPSmonitor/main/agent/install-linux.sh', 302));
app.get('/agent/install-windows.ps1', (c) => c.redirect('https://raw.githubusercontent.com/hynize/CF-Workers-VPSmonitor/main/agent/install-windows.ps1', 302));
